...
export const ROUTES = {
  ...
  userCreate: { path: "/users/create", label: "Tambah User" },
  userDetail: { path: "/users/:id", label: "Detail User" },
  userEdit: { path: "/users/:id/edit", label: "Edit User" },
  ...
  hospital: { path: "/hospitals", label: "Rumah Sakit" },
  hospitalCreate: { path: "/hospitals/create", label: "Tambah Rumah Sakit" },
  hospitalEdit: { path: "/hospitals/:id/edit", label: "Edit Rumah Sakit" },
  ship: { path: "/ships", label: "Kapal" },
  shipCreate: { path: "/ships/create", label: "Tambah Kapal" },
  shipEdit: { path: "/ships/:id/edit", label: "Edit Kapal" },
