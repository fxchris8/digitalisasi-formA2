...
export default function HospitalCreatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.error(
        err instanceof Error ? err.message : "Gagal menambahkan rumah sakit",
      )
    } finally {
      setSaving(false)
    }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Tambahkan rumah sakit baru ke master data.
        </p>
      </div>
      ...
      <Card className="max-w-lg">
        <CardHeader>
          ...
          <CardDescription>
            Isi data rumah sakit dengan lengkap.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                id="name"
                placeholder="Cth: RS Umum Dr. Soetomo"
                value={form.name}
                onChange={(e) =>
