...
const STYLE: Record<
  TimelineStatus,
  {
    ...
    iconColor: string
    labelColor: string
    /** Warna garis penghubung ke langkah berikutnya. */
    connector: string
    label: string
...
> = {
    ...
    connector: "border-solid border-green-600",
    label: "Selesai",
    Icon: Check,
  },
  revision: {
    ...
    connector: "border-solid border-amber-500",
    label: "Perlu Revisi",
    Icon: RefreshCw,
  },
  rejected: {
    ...
    connector: "border-solid border-red-600",
    label: "Ditolak",
    Icon: X,
  },
  pending: {
    ...
    connector: "border-dashed border-gray-300",
    label: "Menunggu",
    Icon: Clock,
  },
}
...
function TimelineItem({
  ...
  return (
    <div className="flex gap-4">
      {/* Circle + connector — garis mengisi penuh sisa tinggi baris supaya
          benar-benar menyambung ke lingkaran langkah berikutnya. */}
      <div className="flex flex-col items-center self-stretch">
        ...
        {!isLast && (
          <div className={`w-0 min-h-4 flex-1 border-l-2 ${s.connector}`} />
        )}
      </div>
